...
@Component({
    selector: 'app-listagem-page-minhas-pecas',
    templateUrl: './listagem-page-minhas-pecas.component.html',
    styleUrls: ['./listagem-page-minhas-pecas.component.css']
})
export class ListagemPageMinhasPecasComponent implements OnInit {
